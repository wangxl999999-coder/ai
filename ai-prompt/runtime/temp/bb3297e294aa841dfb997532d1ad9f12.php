<?php /*a:2:{s:56:"D:\my\tare-git\ai\ai-prompt\app\view\workflow\index.html";i:1776869496;s:53:"D:\my\tare-git\ai\ai-prompt\app\view\layout\base.html";i:1776845020;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">工作流库</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white fw-bold">
                    <i class="bi bi-grid-3x3-gap me-2"></i>工作流分类
                </div>
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        <a href="/workflow" class="list-group-item list-group-item-action <?php if(!$categoryId): ?>active<?php endif; ?> border-0">
                            <i class="bi bi-grid me-2"></i>全部工作流
                        </a>
                        <?php foreach($categories as $category): ?>
                        <a href="/workflow?category_id=<?php echo htmlentities((string) $category['id']); ?>" class="list-group-item list-group-item-action <?php if($categoryId == $category['id']): ?>active<?php endif; ?> border-0">
            ...
            <div class="card border-0 shadow-sm mt-4">
                ...
                <div class="card-body p-2">
                    <div class="list-group list-group-flush">
                        <a href="/workflow?category_id=<?php echo htmlentities((string) $categoryId); ?>&sort=new" class="list-group-item list-group-item-action <?php if($sort == 'new'): ?>active<?php endif; ?> border-0">
                            <i class="bi bi-clock me-2"></i>最新发布
                        </a>
                        <a href="/workflow?category_id=<?php echo htmlentities((string) $categoryId); ?>&sort=hot" class="list-group-item list-group-item-action <?php if($sort == 'hot'): ?>active<?php endif; ?> border-0">
                            <i class="bi bi-fire me-2"></i>最多浏览
                        </a>
                        <a href="/workflow?category_id=<?php echo htmlentities((string) $categoryId); ?>&sort=like" class="list-group-item list-group-item-action <?php if($sort == 'like'): ?>active<?php endif; ?> border-0">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/workflow/create" class="btn btn-success btn-sm">
                    <i class="bi bi-plus-circle"></i> 发布工作流
                </a>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm hover-card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <a href="/workflow/detail?id=<?php echo htmlentities((string) $item['id']); ?>" class="text-decoration-none text-dark">
                        ...
                        <div class="card-footer bg-white border-top-0">
                            <div class="d-flex gap-2">
                                <a href="/workflow/detail?id=<?php echo htmlentities((string) $item['id']); ?>" class="btn btn-sm btn-outline-success w-100">
                                    查看详情
                                </a>
                            </div>
                        </div>
            ...
            <nav class="mt-5">
                <ul class="pagination justify-content-center">
                    <?php if($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="/workflow?category_id=<?php echo htmlentities((string) $categoryId); ?>&sort=<?php echo htmlentities((string) $sort); ?>&page=<?php echo htmlentities((string) $page-1); ?>">
                            <i class="bi bi-chevron-left"></i>
                        </a>
                    </li>
                    <?php endif; foreach(range(1, $totalPage) as $i): ?>
                    <li class="page-item <?php if($page == $i): ?>active<?php endif; ?>">
                        <a class="page-link" href="/workflow?category_id=<?php echo htmlentities((string) $categoryId); ?>&sort=<?php echo htmlentities((string) $sort); ?>&page=<?php echo htmlentities((string) $i); ?>"><?php echo htmlentities((string) $i); ?></a>
                    </li>
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted mt-3">暂无工作流，快来发布第一个吧！</p>
                <a href="/workflow/create" class="btn btn-success">
                    <i class="bi bi-plus-circle"></i> 发布工作流
                </a>
            </div>
            <?php endif; ?>
