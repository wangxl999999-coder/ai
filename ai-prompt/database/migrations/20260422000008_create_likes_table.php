...
class CreateLikesTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('likes', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '点赞表']);
        $table->addColumn('user_id', 'integer', ['limit' => 11, 'null' => false, 'default' => 0, 'comment' => '用户ID'])
              ->addColumn('target_type', 'string', ['limit' => 50, 'null' => false, 'default' => '', 'comment' => '目标类型：prompt提示词、workflow工作流、comment评论'])
