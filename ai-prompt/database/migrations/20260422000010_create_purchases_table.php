...
class CreatePurchasesTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('purchases', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '用户已购买记录表']);
        $table->addColumn('user_id', 'integer', ['limit' => 11, 'null' => false, 'default' => 0, 'comment' => '用户ID'])
              ...
              ->addColumn('points', 'integer', ['limit' => 11, 'null' => false, 'default' => 0, 'comment' => '支付的积分'])
