...
class CreatePromptsTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('prompts', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '提示词表']);
        $table->addColumn('user_id', 'integer', ['limit' => 11, 'null' => false, 'default' => 0, 'comment' => '发布用户ID'])
              ...
              ->addColumn('content', 'text', ['null' => false, 'comment' => '提示词内容'])
              ...
              ->addColumn('points_reward', 'integer', ['limit' => 11, 'null' => false, 'default' => 2, 'comment' => '发布获得的积分奖励'])
